#
#  Be sure to run `pod spec lint ILPMediaPicker.podspec' to ensure this is a
...
ILPMediaPicker provides a simple way to select multiple images/video or create new ones using camera. It allows to define a prefered size for assets thumbnail.
  ...
  # Or just: s.author    = "Evgeniy Novikov"
  # s.authors            = { "Evgeniy Novikov" => "neovajohn@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Evgeniy Novikov"
  ...
  s.source_files  = "ILPMediaPicker/**/*.{h,m,xib}"
  ...
  # s.resource  = "icon.png"
  s.resources = "ILPMediaPicker/Resources/ILPMediaPicker.bundle"
